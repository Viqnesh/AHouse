 ...
 */
final class Version20210627200445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coordonnees ADD civilite VARCHAR(200) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coordonnees DROP civilite');
