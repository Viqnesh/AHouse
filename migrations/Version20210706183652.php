 ...
 */
final class Version20210706183652 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE calendrier ADD CONSTRAINT FK_B2753CB9A74ADF1 FOREIGN KEY (id_habitat_id) REFERENCES habitat (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
